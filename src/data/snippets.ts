export const ALGORITHM_SNIPPETS: Record<string, Record<string, string>> = {
  'bubble-sort': {
...
console.log("Index of 25:", binarySearch(arr, 25));`,
...
print("Index of 25:", binary_search(arr, 25))`,
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Index of 25: " + binarySearch(arr, 25));
    }
}`
  },
  'linked-list': {
    javascript: `// Linked List in JavaScript
class Node {
  constructor(data) {
    this.data = data;
    this.next = null;
