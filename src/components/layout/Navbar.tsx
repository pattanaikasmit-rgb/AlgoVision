...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-card/80 backdrop-blur-md border-b border-accent">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <Link to="/" className="flex items-center gap-1 group">
            <span className="text-2xl font-serif italic font-black text-primary tracking-tighter transition-all group-hover:tracking-normal">
              Algo
            </span>
            <span className="text-2xl font-serif font-black text-accent-primary tracking-tighter transition-all group-hover:tracking-normal">
              Vision
            </span>
          </Link>
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      layoutId="activeNav"
                      className="absolute -bottom-[18px] left-0 right-0 h-1 bg-accent-primary rounded-t-full"
